      ...
      <div className="mt-4">
        ...
        <div className="flex flex-wrap items-center text-sm text-gray-600 mt-2">
          <p className="flex items-center mr-4">
            ...
            <svg className="w-4 h-4 text-gray-800 dark:text-[#e85f5f]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
        ...
        <ul className="list-none text-sm text-gray-700 mt-2 space-y-1">
          <li className="flex items-center">
            ...
            <svg className="w-5 h-5 text-gray-800 dark:text-[#e85f5f]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
